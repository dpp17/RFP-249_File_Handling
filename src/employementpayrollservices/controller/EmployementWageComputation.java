package employementpayrollservices.controller;

import java.util.Scanner;

import employementpayrollservices.interfaces.IWageComputation;
import employementpayrollservices.model.Computation;
import employementpayrollservices.services.ImplementationWageComputation;
...
//	}
	...
	public static void computeEmployeeWage(int classMethodCompanyChoice, int wagePerHour, int fullDayHour) {
		if (classMethodCompanyChoice == 1) {
			...
			System.out.println("Enter number of Working Hour:: ");
			computation.setPartTimeHour(getUserInput.nextInt());
			computation.setPartTimeWage(getEmployee.dailyPartTimeEmployeeWage(computation.getPartTimeHour(),
					wagePerHour, computation.getPresentPartTime()));
		}
	}
...
//wage for single employee per day
				computation.setFullTimeWage(getEmployee.dailyFullTimeEmployeeWage(computation.fullDayHour,
						computation.wagePerHour, computation.getPresentFullTime()));
				break;
			case 2:
//number of employees present per day
				computation.setPresentPartTime(getEmployee.employeesPresentPartTime());
//wage for single employee per day
				...
				computation.setPartTimeHour(getUserInput.nextInt());
				computation.setPartTimeWage(getEmployee.dailyPartTimeEmployeeWage(computation.getPartTimeHour(),
						computation.wagePerHour, computation.getPresentPartTime()));
				break;
//Employement_Wage for a Month
			case 3:
				...
				if (choice == 1) {
					computation.setWageForMonth(
							getEmployee.wageForMonth(20, computation.wagePerHour, computation.fullDayHour));
				} else if (choice == 2) {
					computation.setWageForMonth(
							getEmployee.wageForMonth(20, computation.wagePerHour, computation.fullDayHour));
				}
			...
			case 6:
				...
				do {
					...
					case 1:
						...
						fileHandling.writeFile(" *****   RELIANCE   ***** ");
						wagePerHour = 12;
						fullDayHour = 7;
					...
					case 2:
						...
						fileHandling.writeFile(" *****   Walmart   ***** ");
						wagePerHour = 13;
						fullDayHour = 10;
						getWage(wagePerHour, fullDayHour);
						break;
					case 3:
						...
						fileHandling.writeFile(" *****   UnitedHealthGroups   ***** ");
						wagePerHour = 9;
						fullDayHour = 9;
						getWage(wagePerHour, fullDayHour);
						break;
					case 4:
						...
						fileHandling.writeFile(" *****   ZS Associates   ***** ");
						wagePerHour = 14;
						fullDayHour = 8;
						getWage(wagePerHour, fullDayHour);
						break;
					case 5:
						String[] companyNames = { " *****   RELIANCE   ***** ", " *****   Walmart   ***** ",
								" *****   UnitedHealthGroups   ***** ", " *****   ZS Associates   ***** " };
